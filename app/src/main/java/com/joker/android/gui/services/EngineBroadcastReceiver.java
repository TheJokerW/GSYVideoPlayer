...
public class EngineBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (Intent.ACTION_MEDIA_MOUNTED.equals(action)) {
                Asyncs.async(context, EngineBroadcastReceiver::handleMediaMounted, intent);
            } else if (Intent.ACTION_MEDIA_UNMOUNTED.equals(action)) {
                Asyncs.async(this, EngineBroadcastReceiver::handleMediaUnmounted, intent);
                ...
                Asyncs.async(this, EngineBroadcastReceiver::handleConnectivityChange, context, intent);
            }
        } catch (Throwable e) {
    ...
    private void handleDisconnectedNetwork(NetworkInfo networkInfo) {
        ...
        Asyncs.async(Engine.instance()::stopServices, true);
    }
