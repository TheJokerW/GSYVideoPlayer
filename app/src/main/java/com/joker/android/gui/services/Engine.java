...
import com.joker.android.gui.services.EngineService.EngineServiceBinder;
...
public final class Engine implements IEngineService {
    ...
    public void onApplicationCreate(Application application) {
        Asyncs.async(new EngineApplicationRefsHolder(this, application), Engine::engineServiceStarter);
    }
    ...
    public void startServices() {
        if (service != null || wasShutdown) {
            ...
            if (wasShutdown) {
                Asyncs.async(new EngineApplicationRefsHolder(this, getApplication()),
...
//                        UIUtils.showLongMessage(context, R.string.frostwire_start_engine_service_security_exception);
    ...
    public static void enqueueServiceJob(final Context context, final Intent intent) {
        JobIntentService.enqueueWork(context, EngineService.class, Constants.JOB_ID_ENGINE_SERVICE, intent);
    }
