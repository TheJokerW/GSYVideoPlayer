...
import com.joker.downloader.licenses.License;
import com.joker.downloader.licenses.Licenses;
...
public class CopyrightLicenseBroker implements Mappable<String, Map<String, String>> {
    ...
    public CopyrightLicenseBroker(Map<String, Entry> map) {
        if (map.containsKey("creative-org.apache.commons")) {
            licenseCategory = LicenseCategory.CreativeCommons;
    ...
    public enum LicenseCategory {
        CreativeCommons("creative-org.apache.commons"), OpenSource("open-source"), PublicDomain("public-domain"), NoLicense("no-license");
        private String name;
