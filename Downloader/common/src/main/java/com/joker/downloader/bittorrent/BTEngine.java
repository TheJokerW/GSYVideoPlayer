...
package com.joker.downloader.bittorrent;
...
import com.joker.downloader.platform.FileSystem;
import com.joker.downloader.platform.Platforms;
import com.joker.downloader.search.torrent.TorrentCrawledSearchResult;
import com.joker.downloader.util.Logger;
...
public final class BTEngine extends SessionManager {
    ...
    /**
     * @see com.joker.downloader.android.gui.MainApplication.start() for ctx.interfaces and the rest of the context
     */
    @Override
    public void start() {
