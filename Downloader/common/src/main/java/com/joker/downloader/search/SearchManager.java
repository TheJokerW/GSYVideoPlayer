...
package com.joker.downloader.search;


import com.joker.downloader.search.filter.SearchTable;
import com.joker.downloader.util.Logger;
import com.joker.downloader.util.Ref;
import com.joker.downloader.util.ThreadPool;
import com.joker.downloader.util.http.OkHttpClientWrapper;
...
public final class SearchManager {
    ...
    private void onResults(SearchPerformer performer, List<? extends SearchResult> results) {
        LinkedList list = new LinkedList<SearchResult>();
        results.forEach(sr -> {
