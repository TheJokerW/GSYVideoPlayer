...
package com.joker.downloader.search.yify;

import com.joker.downloader.search.PerformersHelper;
import com.joker.downloader.search.SearchMatcher;
import com.joker.downloader.search.torrent.AbstractTorrentSearchResult;
...
public final class YifySearchResult extends AbstractTorrentSearchResult {
    ...
    private static long buildCreationTime(String str) {
        try {
            return new SimpleDateFormat("M/d/y", Locale.US).parse(str).getTime();
        } catch (Throwable e) {
            // not that important
